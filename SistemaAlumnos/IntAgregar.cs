...
namespace SistemaAlumnos
{
    class IntAgregar : Form
    {
        ...
        private void InicializarComponentes()
        {
            ...
            botonAceptar.Location = new Point(100,200);
            ...
            botonCancelar.Location = new Point(250, 200);
            ...
            //Añadir componentes
            tableLayout.Controls.Add(labelNombre, 0, 0);
            tableLayout.Controls.Add(labelApellidoP, 0, 1);
            tableLayout.Controls.Add(labelApellidoM, 0, 2);
            tableLayout.Controls.Add(labelFechN, 0 , 3);
            tableLayout.Controls.Add(labelDom, 0 , 4);
            tableLayout.Controls.Add(labelMatri, 0, 5);
            tableLayout.Controls.Add(textBoxNombre, 1, 0);
            tableLayout.Controls.Add(textBoxApellidoP, 1, 1);
            tableLayout.Controls.Add(textBoxApellidoM, 1, 2);
            tableLayout.Controls.Add(textBoxFechN, 1, 3);
            tableLayout.Controls.Add(textBoxDom, 1, 4);
            tableLayout.Controls.Add(textBoxMatri, 1, 5);
